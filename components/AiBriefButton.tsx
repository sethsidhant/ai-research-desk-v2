...
// Split response into bullet lines
...
function BriefModal({
  title, brief, onClose,
}: { title: string; brief: string; onClose: () => void }) {
      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-xs font-bold" style={{ color: 'var(--artha-text)', letterSpacing: '-0.01em' }}>
                AI Brief
              </div>
        ...
        <div className="px-5 py-4 space-y-3">
          {bullets.length > 0 ? bullets.map((bullet, i) => (
            ...
            // Fallback: render raw text if bullet parsing fails
